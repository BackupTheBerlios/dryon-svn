...
static swig_type_info _swigt__p_RubyScript[] = {{"_p_RubyScript", 0, "RubyScript *", 0},{"_p_RubyScript"},{0}};
static swig_type_info _swigt__p_chan_Info[] = {{"_p_chan_Info", 0, "chan_Info *", 0},{"_p_chan_Info"},{0}};
static swig_type_info _swigt__p_user_Info[] = {{"_p_user_Info", 0, "user_Info *", 0},{"_p_user_Info"},{0}};
static swig_type_info _swigt__p_vectorTuser_Info_p_t[] = {{"_p_vectorTuser_Info_p_t", 0, "vector<user_Info * > *", 0},{"_p_vectorTuser_Info_p_t"},{0}};
