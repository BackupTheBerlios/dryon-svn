...
EXPORT void *xmalloc _((long));
EXPORT void *xcalloc _((long,long));
EXPORT void *xrealloc _((void*,long));
EXPORT void xfree _((void*));
...
#if defined(_WIN32) && defined(RUBY_DLL)
