 ...
 *
 *  Version: $Id: sc4.c,v 1.1 2004/04/05 15:23:38 anthalir Exp $
 */
#include <assert.h>
#include <ctype.h>
#include <stdio.h>
...
SC_FUNC void defsymbol(char *name,int ident,int vclass,cell offset,int tag)
{
  ...
  /* add a comment for the peephole optimizer */
  if (vclass==sLOCAL) {
    stgwrite("\t;$lcl ");
    stgwrite(name);
    stgwrite(" ");
