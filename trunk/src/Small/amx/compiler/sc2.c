 ...
 *
 *  Version: $Id: sc2.c,v 1.1 2004/04/05 15:23:38 anthalir Exp $
 */
#include <assert.h>
#include <stdio.h>
#include <stdlib.h>
...
static char *extensions[] = { ".inc", ".sma", ".small" };
  ...
  sc_is_utf8=scan_utf8(inpf,name);
  return TRUE;
}
 ...
 *
 *  Small has stricter definition for rational numbers than most:
